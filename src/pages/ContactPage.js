    ...
    <div className="contact-page">
      ...
      <div className="contact-container">
        <div className="contact-info">
          ...
          <p>Indirizzo: Via di Monserrato, 11, 00186 Roma RM, Italia</p>
          <p>Telefono: <a href="tel:+391234567890">+39 123 456 7890</a></p>
          <p>Instagram: <a href="https://www.instagram.com/mobina_gallery" target="_blank" rel="noopener noreferrer">@mobina_gallery</a></p>
        </div>
